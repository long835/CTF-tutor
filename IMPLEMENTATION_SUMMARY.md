> **Historical note.** This document describes an earlier phase-1 pull request
> and is kept for provenance. For current status see `README.md`, for the module
> map see `ARCHITECTURE.md`, and for what changed most recently see
> `CHANGELOG.md`.
